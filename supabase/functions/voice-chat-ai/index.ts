...
serve(async (req) => {
  ...
  try {
    ...
    console.log(
      `Processing request: generateSampleQuestions=${generateSampleQuestions}, question="${question?.substring(
        0,
        50
      )}..."`
    );
  ...
  for (let i = 0; i < models.length; i++) {
    ...
    try {
      ...
      if (aiResponse && aiResponse.length > 5) {
        ...
        console.log(
          `Model ${model} returned empty/invalid response:`,
          aiResponse
        );
      }
    } catch (error) {
...
function generateIntelligentResponse(
  ...
  console.log(
    `Generating intelligent response for: "${questionLower}" in ${language}`
  );
  ...
  const responses: Record<string, Record<string, string>> = {
    english: {
      ...
      wheat:
        "For wheat farming: Sow in November-December, ensure good drainage, apply nitrogen in 2-3 splits during growth stages. Irrigate at critical stages: crown root initiation, tillering, and grain filling.",
      tomato:
        "For tomato cultivation: Start with healthy seedlings, provide support stakes, water consistently but avoid wetting leaves, and apply potassium-rich fertilizer during fruiting. Watch for blight and pest infestations.",
      ...
      fertilizer:
        "For fertilizer management: Test soil first, apply organic compost, use balanced NPK based on crop needs, and avoid over-fertilization which can reduce quality and increase pest problems.",
      disease:
        "For disease management: Ensure good air circulation, avoid overhead watering, remove infected plant parts immediately, use resistant varieties, and apply fungicides preventively if needed.",
      water:
        "For water management: Use drip irrigation for efficiency, mulch to retain moisture, water early morning or evening, monitor soil moisture at root depth, and avoid waterlogging.",
      organic:
        "For organic farming: Build soil with compost and green manures, use crop rotation, encourage biodiversity, practice companion planting, and rely on natural pest control methods.",
      ...
      default:
        "For successful farming: Focus on soil health, choose appropriate varieties for your climate, manage water efficiently, monitor for pests and diseases, and maintain proper nutrition balance.",
    },
    hindi: {
      ...
      wheat:
        "गेहूं की खेती के लिए: नवंबर-दिसंबर में बुआई करें, अच्छी जल निकासी सुनिश्चित करें, नाइट्रोजन को 2-3 भागों में डालें। महत्वपूर्ण अवस्थाओं में सिंचाई करें।",
      ...
      fertilizer:
        "उर्वरक प्रबंधन के लिए: पहले मिट्टी जांच कराएं, जैविक खाद डालें, फसल की आवश्यकता के अनुसार संतुलित NPK का प्रयोग करें।",
      default:
        "सफल खेती के लिए: मिट्टी की सेहत पर ध्यान दें, जलवायु के अनुकूल किस्में चुनें, पानी का कुशल प्रबंधन करें, कीट-रोगों की निगरानी करें।",
    },
    tamil: {
      ...
      wheat:
        "கோதுமை விவசாயத்திற்கு: நவம்பர்-டிசம்பரில் விதைக்கவும், நல்ல வடிகால் உறுதி செய்யவும், வளர்ச்சி நிலைகளில் நைட்ரஜனை 2-3 பகுதிகளாக பயன்படுத்தவும்.",
      ...
      fertilizer:
        "உர நிர்வாகத்திற்கு: முதலில் மண் பரிசோதனை செய்யுங்கள், இயற்கை உரம் போடுங்கள், பயிர் தேவைக்கு ஏற்ப சமநிலையான NPK பயன்படுத்துங்கள்.",
      default:
        "வெற்றிகரமான விவசாயத்திற்கு: மண் ஆரோக்கியத்தில் கவனம் செலுத்துங்கள், உங்கள் காலநிலைக்கு ஏற்ற ரகங்களை தேர்வு செய்யுங்கள், நீரை திறமையாக நிர்வகிக்கவும்.",
    },
  };
...
function getEmergencyResponse(language: string): string {
  const emergency: Record<string, string> = {
    english:
      "I'm here to help with your farming questions. Please try asking about specific crops, pest control, fertilizers, or farming techniques. For immediate help, contact your local agricultural extension office.",
    hindi:
      "मैं आपके खेती के सवालों में मदद के लिए यहाँ हूँ। कृपया विशिष्ट फसलों, कीट नियंत्रण, उर्वरकों या खेती तकनीकों के बारे में पूछें।",
    tamil:
      "உங்கள் விவசாய கேள்விகளுக்கு உதவ நான் இங்கே இருக்கிறேன். குறிப்பிட்ட பயிர்கள், பூச்சி கட்டுப்பாடு, உரங்கள் அல்லது விவசாய நுட்பங்களைப் பற்றி கேட்கவும்.",
  };
